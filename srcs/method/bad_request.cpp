...
/*   Updated: 2022/01/10 16:53:42 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::string	file = file_to_string("config/default/html_page/400_bad_request.html");
...
{
    std::string	file = file_to_string("config/default/html_page/405_not_allowed.html");
	//std::cout << "seg est ici [BAD REQUEST]" << std::endl;
